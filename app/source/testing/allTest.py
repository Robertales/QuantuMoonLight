...
#         tester = app.test_client(self)
#         pathTrain = pathlib.Path(__file__).parents[0] / "testingFiles" / "DataSetTrainPreprocessato.csv"
#         pathTest = pathlib.Path(__file__).parents[0] / "testingFiles" / "DataSetTestPreprocessato.csv"
#         pathPrediction = pathlib.Path(__file__).parents[0] / "testingFiles" / "doPrediction.csv"
...
#         self.assertEqual(statuscode, 200)
#         self.assertTrue(
#             exists(pathlib.Path(__file__).parents[2] / "upload_dataset" / "classifiedFile.csv"))
